...
$(document).ready(function() {
    ...
    $(document).on("click", '.search_btn', function(event) {
        ...
        if(value_f==''){
            ...
            var suc_str =   '<div class="succec_log">'+
                            '<span class="sm_err">Адрес доступен!</span>'+
                            '<span class="big_err">'+value_f+'</span>'+
                            '</div>'+
                            '<span class="btn_repeat suc">Еще раз!</span>';
            ...
            var err_str =   '<div class="err_log">'+
                            '<span class="sm_err">Адрес уже занят</span>'+
                            '<span class="big_err">'+value_f+'</span>'+
                            '</div>'+
                            '<span class="btn_repeat">Еще раз!</span>';
            search_str = $('.search_form').children().detach();
    ...
    $('.access_btn.orange, .cheking').click(function(e){
        ...
        {
            $('.col_text.address_str').text('не выбран');
            $('.col_text.address_str').addClass('no_sel');
            $('.col_text.tarif_str').text('не выбран');
        }
